	...
	return (
		<div className="flex flex-row border w-[450px] h-52 items-center mr-2 rounded-xl shadow-md hover:shadow-xl">
			<div className="w-2/5 flex justify-center  items-center">
				<div className="h-40 w-40 bg-slate-400 rounded-xl"></div>
			</div>
			<div className="w-3/5 flex flex-col">
				<div className="flex flex-row w-full h-28">
					<div className="flex flex-col w-4/5">
						<div className="font-roboto font-bold text-lg mb-2">Pancakes</div>
						<div className="text-sm pr-1 text-gray-600">
							A blend of fresh berries with a twist of spice
						</div>
					</div>
				...
				<div className="flex flex-row w-full h-12 justify-between pr-2">
					...
					<div className="w-[40%] h-full border flex items-center justify-center  bg-slate-900 rounded-lg font-bold capitalize text-white">
